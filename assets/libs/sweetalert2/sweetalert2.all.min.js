...
!(function (e, t) {
  ...
  const t = (e) => {
    ...
    g = () =>
      document.body.querySelector(`.${n.container}`),
    h = (e) => {
      const t = g();
    ...
    I = (e, t) => {
      if (((e.textContent = ""), t)) {
        ...
        Array.from(
          n.querySelector("head").childNodes
        ).forEach((t) => {
          e.appendChild(t);
        }),
          Array.from(
  ...
  const Ae = (t, o) => {
    ...
    Ee = (e) =>
      `<div class="${n["icon-content"]}">${e}</div>`,
    $e = (e, t) => {
      (e.className = `${n.popup} ${
        J(e) ? t.showClass.popup : ""
      }`),
        t.toast
          ? (R(
              [document.documentElement, document.body],
    ...
    Se = (e) => {
      ...
      return (
        ...
        e.progressStepsDistance &&
          W(t, "width", e.progressStepsDistance),
        t
      );
    },
    Le = (t, i) => {
      ((e, t) => {
        ...
        ((t, n) => {
          const i = e.innerParams.get(t),
            s = y();
          if (i && n.icon === i.icon)
            return Pe(s, n), void ke(s, n);
          if (n.icon || n.iconHtml) {
            if (
              n.icon &&
              -1 === Object.keys(o).indexOf(n.icon)
            )
              return (
                a(
  ...
  const tt = (t) => {
    ...
    const i = g();
    return (
      U(i, o.showClass.backdrop),
      R(i, o.hideClass.backdrop),
      it(t, n, o),
      !0
    );
  };
  const nt = (t) => {
    ...
    st = (e, t, n, o, i) => {
      (ee.swalCloseEventFinishedCallback = Qe.bind(
        null,
        e,
        n,
        o,
  ...
  function lt(e, t) {
    if (e)
      if ("radio" === e.type) {
        const n =
          e.parentNode.parentNode.querySelectorAll("input");
        for (let e = 0; e < n.length; e++)
          n[e].disabled = t;
      } else e.disabled = t;
  }
  const ct = {
    ...
    bt = (e) => {
      pt.includes(e) &&
        r(
          `The parameter "${e}" is incompatible with toasts`
        );
    },
    yt = (e) => {
      ht(e) && c(e, ht(e));
  ...
  const wt = (e) => {
    ...
    return (
      Object.keys(e).forEach((n) => {
        gt(n)
          ? (t[n] = e[n])
          : r(`Invalid parameter to update: ${n}`);
      }),
      t
    );
  };
  ...
  const Bt = (e) => {
    ...
    Ht = (t, n, o) => {
      ...
      Promise.resolve()
        .then(() =>
          p(i.inputValidator(n, i.validationMessage))
        )
        .then((e) => {
          t.enableButtons(),
            t.enableInput(),
    ...
    Vt = (t, n) => {
      ...
      if ((o.showLoaderOnConfirm && Bt(), o.preConfirm)) {
        ...
        Promise.resolve()
          .then(() =>
            p(o.preConfirm(n, o.validationMessage))
          )
          .then((e) => {
            J(k()) || !1 === e
              ? (t.hideLoading(), nt(t))
  ...
  var Gt = Object.freeze({
    ...
    enableLoading: Bt,
    getTimerLeft: () =>
      ee.timeout && ee.timeout.getTimerLeft(),
    stopTimer: Kt,
    resumeTimer: Yt,
    toggleTimer: () => {
      const e = ee.timeout;
    ...
    isTimerRunning: () =>
      ee.timeout && ee.timeout.isRunning(),
    bindClickHandler: function () {
      ...
      (Jt[e] = this),
        Zt ||
          (document.body.addEventListener("click", Xt),
          (Zt = !0));
    },
  });
  class Qt {
  ...
  const en = ["swal-title", "swal-html", "swal-footer"],
    ...
    pn = (e) => {
      ...
      const n = g();
      t.removeEventListener(ce, pn),
        (n.style.overflowY = "auto");
    },
    mn = (e, t) => {
      ce && G(t)
        ? ((e.style.overflowY = "hidden"),
          t.addEventListener(ce, pn))
  ...
  class wn {
    ...
    _main(t) {
      ...
      ((e) => {
        ...
        ee.currentInstance &&
          (ee.currentInstance._destroy(), j() && ze()),
        (ee.currentInstance = yn);
      const o = Cn(t, n);
      bn(o),
        Object.freeze(o),
        ee.timeout &&
          (ee.timeout.stop(), delete ee.timeout),
        clearTimeout(ee.restoreFocusTimeout);
      const i = An(yn);
      return (
        Le(yn, o), e.innerParams.set(yn, o), vn(yn, i, o)
      );
    }
    then(t) {
  ...
  const vn = (t, n, o) =>
    ...
    Bn = (e, t) => {
      t.toast ||
        (u(t.allowEnterKey) ? Pn(e, t) || De(-1, 1) : xn());
    },
    Pn = (e, t) =>
