...
((options = {
    ...
    chart: { height: 290, type: "area", toolbar: "false", width: '100%' },
    dataLabels: { enabled: !1 },
    stroke: { curve: "smooth", width: 2 },
    xaxis: {categories: periodMap[choosedValue].options.xaxis.categories, labels: {
        rotate: 0,
        formatter: function (e) {
            const last = periodMap['last-month'].options.xaxis.categories[periodMap['last-month'].options.xaxis.categories.length-1];
            return choosedValue === 'last-month' && e == last ? `${e} d.` : e
        },
      }},
    yaxis: {
        labels: {
