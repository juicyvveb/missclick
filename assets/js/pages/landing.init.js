...
/* Old Counter function (Scrolling)
function counter() {
  ...
  function startCounterWhenVisible() {
    e && e && Array.from(e).forEach(function(l) {
      if (isInViewport(l)) {
        ...
        var o = n / 3500;
        o < 1 && (o = 1);
        t < n ? (l.innerText = (t + o).toFixed(0), setTimeout(startCounterWhenVisible, 1)) : l.innerText = i(n), i(l.innerText);
		setTimeout(startCounterWhenVisible, 10);
      }
    });
  }
