                            ...
                            l.classList.add("was-validated"),
                                l.querySelectorAll(".tab-pane.show .form-control").forEach(function (e) {
                                    0 < e.value.length &&
                                        ...
                                        ((e = t.getAttribute("data-nexttab")), document.getElementById(e).click(), l.classList.remove("was-validated"));
                                });
                        });
                }),
                l.querySelectorAll(".previestab") &&
                    Array.from(l.querySelectorAll(".previestab")).forEach(function (o) {
                        o.addEventListener("click", function () {
                            for (var e = o.getAttribute("data-previous"), t = o.closest("form").querySelectorAll(".custom-nav .done").length, r = t - 1; r < t; r++)
                        ...
                        r.addEventListener("click", function () {
                            ...
                            l.classList.remove("was-validated"),
                                r.getAttribute("data-progressbar") &&
                                    ...
                                    (e = (o / e) * 100),
                                    (document.getElementById("custom-progress-bar").querySelector(".progress-bar").style.width = e + "%")),
