...
// Bitcoin cash
var areachartbitcoinCashColors = getChartColorsArray("bitcoincash_sparkline_charts");
if (areachartbitcoinCashColors) {
    var options = {
        series: [{
            name: "BitcoinCash",
            data: [85, 68, 35, 90, 8, 11, 26, 54],
        ...
        colors: areachartbitcoinCashColors,
    };
    var chart = new ApexCharts(
        document.querySelector("#bitcoincash_sparkline_charts"),
        options
    );
    chart.render();
}
...
// Ethereum
var areachartethereumColors = getChartColorsArray("ethereum_sparkline_charts");
if (areachartethereumColors) {
  var options = {
    series: [{
      name: "ethereum",
    ...
    colors: areachartethereumColors,
  };
  var chart = new ApexCharts(document.querySelector("#ethereum_sparkline_charts"), options);
  chart.render();
}
...
// Tron
var areacharttronColors = getChartColorsArray("tron_sparkline_charts");
if (areacharttronColors) {
  var options = {
    series: [{
      name: "Tron",
      data: [24, 68, 39, 86, 29, 42, 11, 58],
    ...
    colors: areacharttronColors,
  };
  var chart = new ApexCharts(document.querySelector("#tron_sparkline_charts"), options);
  chart.render();
}

// Ripple
var areachartrippleColors = getChartColorsArray("ripple_sparkline_charts");
if (areachartrippleColors) {
  var options = {
    series: [{
      name: "Ripple",
      data: [12, 42, 39, 16, 42, 26, 6, 12],
    }, ],
    chart: {
      width: 130,
      height: 46,
    ...
    colors: areachartrippleColors,
  };
  var chart = new ApexCharts(document.querySelector("#ripple_sparkline_charts"), options);
  chart.render();
}
...
// DogeCoin
var areachartdogeColors = getChartColorsArray("doge_sparkline_charts");
if (areachartdogeColors) {
  var options = {
    series: [{
      name: "Dogecoin",
    ...
    colors: areachartdogeColors,
  };
  var chart = new ApexCharts(document.querySelector("#doge_sparkline_charts"), options);
  chart.render();
}
