!(function () {
  ...
  function E(e) {
    document.getElementById("header-lang-img") &&
      ...
      null == (y = localStorage.getItem("language")) &&
        E(b),
  ...
  function w(e) {
    if (e.target && e.target.matches("a.nav-link span"))
      if (
        0 == v(e.target.parentElement.nextElementSibling)
      ) {
        ...
        Array.from(
          t.querySelectorAll(".menu-dropdown")
        ).forEach(function (e) {
  ...
  function T(a, e) {
    Array.from(
      document.querySelectorAll("input[name=" + a + "]")
    ).forEach(function (t) {
  ...
  function C(e, t, a, o) {
    ...
    o.setAttribute(e, t),
      n && document.getElementById(a).click();
  }
  function N() {
    ...
    Array.from(
      ...
      0 < e.querySelectorAll(".notification-item").length
        ? e.querySelector(".view-all") &&
          (e.querySelector(".view-all").style.display =
            "block")
        : (e.querySelector(".view-all") &&
            (e.querySelector(".view-all").style.display =
              "none"),
  ...
  sessionStorage.getItem("defaultAttribute")
    ? (((a = {})["data-layout"] =
        sessionStorage.getItem("data-layout")),
      (a["data-sidebar-size"] = sessionStorage.getItem(
        "data-sidebar-size"
      )),
      (a["data-layout-mode"] = sessionStorage.getItem(
        "data-layout-mode"
      )),
      (a["data-layout-width"] = sessionStorage.getItem(
        "data-layout-width"
      )),
      (a["data-sidebar"] =
        sessionStorage.getItem("data-sidebar")),
      (a["data-sidebar-image"] = sessionStorage.getItem(
        "data-sidebar-image"
      )),
      (a["data-layout-position"] = sessionStorage.getItem(
        "data-layout-position"
      )),
      (a["data-layout-style"] = sessionStorage.getItem(
        "data-layout-style"
      )),
      (a["data-topbar"] =
        sessionStorage.getItem("data-topbar")),
      (a["data-preloader"] = sessionStorage.getItem(
        "data-preloader"
      )),
      (a["data-body-image"] = sessionStorage.getItem(
        "data-body-image"
      )),
      z(a))
    ...
    Array.from(m).forEach(function (a) {
      a.addEventListener("click", function () {
        ...
        t["data-toast-text"] &&
          ...
          t["data-toast-close"] &&
            (e.close =
              t["data-toast-close"].value.toString()),
          t["data-toast-style"] &&
            (e.style =
              t["data-toast-style"].value.toString()),
          t["data-toast-offset"] &&
    ...
    Array.from(m)
    .filter(el => el.id != "SelectStatusOperation" && el.id != "SelectPayMentSystem" && el.id != "statusSelectDeposit")
    .forEach(function (e) {
      var t = {},
        a = e.attributes;
      a["data-choices-groups"] &&
        ...
        a["data-choices-search-false"] &&
          (t.searchEnabled = !1),
        a["data-choices-search-true"] &&
          (t.searchEnabled = !0),
        a["data-choices-removeItem"] &&
          (t.removeItemButton = !0),
        a["data-choices-sorting-false"] &&
          (t.shouldSort = !1),
        a["data-choices-sorting-true"] &&
          (t.shouldSort = !0),
        ...
        a["data-choices-limit"] &&
          (t.maxItemCount =
            a["data-choices-limit"].value.toString()),
        a["data-choices-editItem-true"] &&
          (t.maxItemCount = !0),
        a["data-choices-editItem-false"] &&
          (t.maxItemCount = !1),
    ...
    Array.from(m).forEach(function (e) {
      ...
      "flatpickr" == e.getAttribute("data-provider")
        ? ((o = e.attributes),
          ...
          o["data-date-format"] &&
            (t.dateFormat =
              o["data-date-format"].value.toString()),
          o["data-enable-time"] &&
            ((t.enableTime = !0),
            (t.dateFormat =
              o["data-date-format"].value.toString() +
          ...
          o["data-altFormat"] &&
            ((t.altInput = !0),
            (t.altFormat =
              o["data-altFormat"].value.toString())),
          o["data-minDate"] &&
            ((t.minDate =
              o["data-minDate"].value.toString()),
            (t.dateFormat =
              o["data-date-format"].value.toString())),
          o["data-maxDate"] &&
            ((t.maxDate =
              o["data-maxDate"].value.toString()),
            (t.dateFormat =
              o["data-date-format"].value.toString())),
          o["data-deafult-date"] &&
            ((t.defaultDate =
        ...
        : "timepickr" == e.getAttribute("data-provider") &&
          ...
          o["data-min-time"] &&
            ...
            (a.dateFormat = "H:i"),
            (a.minTime =
              o["data-min-time"].value.toString())),
          o["data-max-time"] &&
            ((a.enableTime = !0),
            (a.noCalendar = !0),
            (a.dateFormat = "H:i"),
            (a.minTime =
              o["data-max-time"].value.toString())),
          o["data-default-time"] &&
            ((a.enableTime = !0),
            (a.noCalendar = !0),
            (a.dateFormat = "H:i"),
          ...
          o["data-time-inline"] &&
            ...
            (a.noCalendar = !0),
            (a.defaultDate =
              o["data-time-inline"].value.toString()),
            (a.inline = !0)),
          flatpickr(e, a));
    }),
    Array.from(
